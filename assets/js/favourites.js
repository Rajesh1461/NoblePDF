function updateFavoritesDropdown() {
    ...
    if (!dropdown) {
        // Silently return if the dropdown isn't present on this page
        return;
    }
    dropdown.innerHTML = '';
...
function updateFavoriteIcons() {
    ...
    document.querySelectorAll('.favorite-icon').forEach((icon) => {
        ...
        const isInGroupRecent = parent && parent.closest('#groupRecent') !== null;
        const isInGroupFavorites = parent && parent.closest('#groupFavorites') !== null;
